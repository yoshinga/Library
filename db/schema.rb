...
ActiveRecord::Schema.define(version: 2020_06_29_072925) do
  ...
  create_table "users", primary_key: "uid", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "nickname"
